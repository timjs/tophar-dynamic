...
% \newrelation{symevaluate}      {\;\rotatebox[origin=c]{-90}{$\leadsto$}\;}
% \newrelation{symstride}    {\;\mapstochar\kern+0.1em\leadsto\;}
% \newrelation{symnormalise} {\;\rotatebox[origin=c]{-90}{$\Leadsto$}\;}
