...
\newrule{SH-Pool}
  {n_i|_{\phi}\sigma \symhandle{\iota} t_j'|_{\phi'},\sigma',\delta'}
...
\newrule{SH-Pool-Kill}
  {}
  {\Pool^k_{t_0}[\ldots,n_j,\ldots]|_{\phi},\sigma \symhandle{k\Send\Kill j} \Pool^k_{t_0}[\ldots]|_{\phi'},\sigma',\delta'}
  {\each j}
