...
\newcommand{\RelationT}{\Gamma,\Sigma \infers e : \tau}
...
\newcommand{\TPool}{
   ...
   {\Gamma,\Sigma \infers \PoolText_{t_0} [\many{t}] : \Task (\List \tau)}
   {}
   }
% \newrule{T-Pool}
%   {\Gamma,\Sigma \infers t_0 : \Task \tau \Quad
...
\newcommand{\RelationM}{\infers m : \tau \To \Delta}
...
\newcommand{\RelationS}{m \sim v \To \theta}
...
\newcommand{\RelationE}{e \evaluate v}
...
% \newrule{N-Repeat}
% 	{t,\sigma \normalize n',\sigma',\delta'}
% 	{\Repeat t,\sigma \normalize n' \Step \lambda x. \Select\block{\lbl{Repeat} \mapsto \Repeat t, \lbl{Exit} \mapsto \Lift x},\sigma',\delta'}
%   {}
...
\newcommand{\NPoolName}{
  ...
  {k \text{ fresh}} %\Quad
   ...
   % {\PoolText^\epsilon_{t_0} [\many{t}],\sigma \normalize \PoolText^k_{t_0} [\many{n'}],\sigma_j',\delta_1'\cup\ldots\cup\delta_j'}
   {\PoolText^\epsilon_{t_0} [\ ],\sigma \normalize \PoolText^k_{t_0} [\ ],\sigma,\nothing}
   {}
}
...
% \newrule{N-Assign}
% 	{}
% 	{h \Assign b, \sigma \normalize \Lift \unit, [h \mapsto b]\sigma, \set{h}}
%   {}
...
% \newrule{N-Lift}
%   {}
%   {\Lift v,\sigma \normalize \Lift v,\sigma,\nothing}
%   {}

% \newrule{N-Enter}
%   {}
%   {\Enter\beta,\sigma \normalize \Enter\beta,\sigma,\nothing}
%   {}

% \newrule{N-Update}
%   {}
%   {\Update b,\sigma \normalize \Update b,\sigma,\nothing}
%   {}

% \newrule{N-View}
%   {}
%   {\View b,\sigma \normalize \View b,\sigma,\nothing}
%   {}

% \newrule{N-Select}
%   {}
%   {\Select \block{\many{l_i \mapsto t_i}},\sigma \normalize \Select \block{\many{l_i \mapsto t_i}},\sigma,\nothing}
%   {}

% \newrule{N-Change}
%   {}
%   {\Change h,\sigma \normalize \Change h,\sigma,\nothing}
%   {}

% \newrule{N-Watch}
%   {}
%   {\Watch h,\sigma \normalize \Watch h,\sigma,\nothing}
%   {}
...
\newcommand{\RelationH}{n,\sigma \handle{\iota} t',\sigma',\delta'}
...
\newcommand{\HInit}{
   ...
   {H-Init}
   {}
   {\PoolText^k_{t_0}[\many{n}],\sigma \handle{k \Send \Init} \PoolText^k_{t_0}[\many{n},t_0],\sigma,\nothing}
   {}
   }
...
\newcommand{\HKillsj}{
   ...
   {H-Kill$_j$}
   {}
   {\PoolText^k_{t_0}[\ldots,n_j,\ldots],\sigma \handle{k \Send \Kill j} \PoolText^k_{t_0}[\ldots,\cancel{n_j},\ldots],\sigma,\nothing}
   {\each j}
   }
...
\newcommand{\HPool}{
   ...
   n_j,\sigma_{j-1}' \handle{k' \Send \alpha} n_j',\sigma_j',\delta_j'
 	...
 	{\PoolText^k_{t_0}[\many{n}],\sigma \handle{k' \Send \alpha} \PoolText^k_{t_0}[\many{n'}],\sigma_j',\delta_1'\cup\ldots\cup\delta_j'}
   {}
   }
...
\newcommand{\RelationF}{t,\sigma,\delta \fixate n',\sigma'}
...
\newcommand{\RelationI}{n,\sigma \interact{\iota} n',\sigma'}
...
\newcommand{\RelationSE}{e \symevaluate v|_\phi}
...
%   {}
%   {\Assert b\shaded{|_{\phi}}, \sigma \symnormalize \Lift b\shaded{|_{\phi \land b}}, \sigma, \nothing}
%   {}
...
% \newrule{SF-Done}
%   {t\shaded{|_\phi},\sigma \symnormalize n'\shaded{|_{\phi'}},\sigma',\delta'}
%   {t\shaded{|_\phi},\sigma,\delta \symfixate n'\shaded{|_{\phi'}},\sigma'}
%   {(\delta \cup \delta') \cap \Watching(n') = \nothing}

% \newrule{SF-Loop}
%   {t\shaded{|_\phi},\sigma \symnormalize n'\shaded{|_{\phi'}},\sigma',\delta' \Quad
%    n'\shaded{|_{\phi'}},\sigma',\delta' \symfixate n''\shaded{|_{\phi''}},\sigma''}
%   {t\shaded{|_\phi},\sigma,\delta \symfixate n''\shaded{|_{\phi''}},\sigma''}
%   {(\delta \cup \delta') \cap \Watching(n') \neq \nothing}


\newcommand{\RelationSH}{n|_{\phi},\sigma \symhandle{\iota'} t'|_{\phi'},\sigma',\delta'}
...
\newcommand{\SHPoolj}{
   ...
   {\PoolText^k_{t_0} [\ldots,n_j,\ldots]|_{\phi},\sigma \symhandle{\iota} \PoolText^k_{t_0} [\ldots,t_j',\ldots]|_{\phi'},\sigma',\delta'}
   {\each j}
   }
   
\newcommand{\SHPoolInit}{
    \placerule
   {SH-Pool-Init}
   {}
   {\PoolText^k_{t_0}[\many{n}]|_{\phi},\sigma \symhandle{k\Send\Init} \PoolText^k_{t_0}[\many{n},t_0]|_{\phi'},\sigma',\delta'}
   {}
   }
   
\newcommand{\SHPoolKillj}{
    \placerule
   {SH-Pool-Kill$_j$}
   {}
   {\PoolText^k_{t_0}[\ldots,n_j,\ldots]|_{\phi},\sigma \symhandle{k\Send\Kill j} \PoolText^k_{t_0}[\ldots,\cancel{n_j},\ldots]|_{\phi'},\sigma',\delta'}
   {\each j}
   }
...
\newcommand{\RelationSI}{n|_{\phi},\sigma\ \ \syminteract{\iota'}\ \ n'|_{\phi'},\sigma'}
