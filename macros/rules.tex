...
\newrule{N-Pool-Name}
  {t_1,\sigma \normalise n_1,\sigma_1,\delta_1 \Quad
   \ldots \Quad
   t_j,\sigma_{j-1} \normalise n_j,\sigma',\delta_j}
  {\Pool^\epsilon_{t_0} [\many{t}],\sigma \normalise \Pool^k_{t_0} [\many{n}],\sigma',\bigcup_j \delta_j}
  {k \text{ fresh}}
...
\newrule{H-Kill}
  {}
  {\Pool^k_{t_0}[n_1,\ldots,n_i,\ldots,n_j],\sigma \handle{k \Send \Kill i} \Pool^k_{t_0}[n_1,\ldots,n_j],\sigma,\nothing}
  {}

\newrule{H-Pool}
	{n_1,\sigma \handle{k' \Send \alpha} n_1',\sigma_1',\delta_1' \Quad
   \ldots \Quad
   n_j,\sigma_{j-1} \handle{k' \Send \alpha} n_j',\sigma',\delta_j'
  }
	{\Pool^k_{t_0}[\many{n}],\sigma \handle{k' \Send \alpha} \Pool^k_{t_0}[\many{n'}],\sigma',\bigcup_j \delta_j'}
  {}
...
\newrule{SH-Enter}%XXX: same
  {z' \text{fresh}}
  {\Enter^k\beta\shaded{|_{\phi}},\sigma \symhandle{\send{k}{z'}} \Update^k z'\shaded{|_{\phi}},\sigma,\nothing}
  {z' : \beta}

\newrule{SH-Update}
  {z' \text{fresh}}
  {\Update^k b\shaded{|_{\phi}},\sigma \symhandle{\send{k}{z'}} \Update^k z'\shaded{|_{\phi}},\sigma,\nothing}
  {b,z' : \beta}

\newrule{SH-Change}
  {z' \text{fresh}}
  {\Change^k h\shaded{|_{\phi}},\sigma \symhandle{\send{k}{z'}} \Change^k h\shaded{|_{\phi}},[h \mapsto z']\sigma,\set{h}}
  {\sigma(h),z' : \beta}
...
\newrule{SP-Select}
  ...
  {\foreach l' \in \set{l \mid \lnot\Failing(t_{l})}}
...
\newrule{SI-Handle}%XXX: same
  {n\shaded{|_{\phi}},\sigma \symhandle{\iota} t'\shaded{|_{\phi'}},\sigma',\delta' \Quad
   t'\shaded{|_{\phi'}},\sigma',\delta' \symfixate n''\shaded{|_{\phi''}},\sigma''}
  {n\shaded{|_{\phi}},\sigma \syminteract{\iota} n''\shaded{|_{\phi''}},\sigma''}
  {}
