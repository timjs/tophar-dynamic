\begin{tikzpicture}[x=1pc,y=1pc,line width=1pt,>={Triangle},align=center]
  ...
  \node (valued)   [circle,draw,minimum size=3pc,very thick,right=3 of unvalued] {\emph{valued}};
  \node (shared)   [circle,draw,minimum size=3pc,very thick,right=4 of valued]   {\emph{shared}};
