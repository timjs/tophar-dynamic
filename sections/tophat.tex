...
Also, environments $\Gamma$ and $\Sigma$ are not touched on the task level,
...
With failing we mean it is non-sensible to make a step to:
...
as determination of this value would require to normalise all following steps and tasks,
