...
We then study the implications on \TOPHAT's properties in \cref{sec:properties}, discussing the impact of dynamic tasks on the symbolic execution mechanism, task equivalence, and visualization of tasks.
